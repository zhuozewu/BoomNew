...
<div id="content">
    ...
    <div class="container">
        ...
        <div id="main">
                    ...
                    <li class="comment">
                        ...
                        <div class="comment-body">
                            ...
                            <div class="comment-meta">
                                ...
                                发表者：<b>${reply.author.name}</b>, <span class="date">${reply.postTime}</span>
                            ...
                            <ul class="comment-links">
                                <li><a href="/replyInput/1_-1_${reply.rid}">Reply</a></li>
                            </ul>
                            <!-- .comment-links -->
            ...
            <ul class="pagination">
                <li class="prev"><a href="${pageContext.request.contextPath}/allReplyByNewsId/-1_-1?page=${page.prePage}">Prev</a></li>
                <li><a href="${pageContext.request.contextPath}/allReplyByNewsId/-1_-1?page=${page.prePage}">${page.prePage}</a></li>
                <li class="active"><a href="#">${page.pageNum}</a></li>
                <li><a href="${pageContext.request.contextPath}/allReplyByNewsId/-1_-1?page=${page.nextPage}">${page.nextPage}</a></li>
                <li class="next"><a href="${pageContext.request.contextPath}/allReplyByNewsId/-1_-1?page=${page.nextPage}">Next</a></li>
            </ul>
                ...
                <form method="post" action="${pageContext.request.contextPath }/reply" id="comment-form" class="form clearfix" modelAttribute="reply" method="POST">
                    <div class="textarea_block">
                        ...
                        <p>
                            ...
                            <form:textarea path="content" id="comment" rows="10" cols="45" class="input"/>
                        </p>
